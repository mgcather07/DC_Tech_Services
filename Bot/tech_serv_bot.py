...
class TechServBot(WebexWebsocketClient):
    ...
    def __init__(self,
                 ...
                 bot_name="MIS Tech Services",
                 bot_help_subtitle="Send a command to get started!",
                 threads=True,
                 help_command=None,
                 log_level="INFO",
                 proxies=None):
    ...
    def check_user_approved(self, user_email, approved_rooms):
        ...
        * If both those lists are empty, the user is approved.
        ...
        if not user_approved:
            ...
            self.send_unauthorized_message(user_email)
        return user_approved

    def send_unauthorized_message(self, user_email):
        unauthorized_card = {
            "type": "AdaptiveCard",
            "version": "1.2",
            "body": [
                ...
                {
                    "type": "TextBlock",
                    "text": "Please contact the administrator if you believe this is an error.",
                    "wrap": True
                }
            ]
        }
        ...
        response = {
            ...
            "markdown": "You're not authorized to use this bot.",
            "attachments": [
                {
                    "contentType": "application/vnd.microsoft.card.adaptive",
                    "content": unauthorized_card
                }
            ]
        }

        self.teams.messages.create(**response)
